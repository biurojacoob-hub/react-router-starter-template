...
const mainNav = [
  ...
  { label: "Lekcje", href: "/lessons", icon: BookOpen, badge: "3 nowe" },
      ...
      <div className="px-4 py-4 border-b">
        <div className="flex items-center gap-3 rounded-xl bg-muted/50 p-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full gradient-brand text-white font-bold text-sm">
            {DEMO_USER.childName[0]}
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold truncate">{DEMO_USER.childName}</p>
            <p className="text-xs text-muted-foreground">
              Poziom {DEMO_USER.level} · {DEMO_USER.xp} XP
            </p>
          </div>
